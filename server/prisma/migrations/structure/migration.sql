...
CREATE TABLE "Route" (
    ...
    "route_name" STRING(30) NOT NULL,
    "path_route" STRING(100),
    "parent_id" STRING,
    "order_path" INT4 NOT NULL,
    "path_key" STRING NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "path_side" STRING(100),
...
CREATE TABLE "RoleRoute" (
    "role_route_id" STRING NOT NULL,
    "role_id" STRING NOT NULL,
    "route_id" STRING NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "RoleRoute_pkey" PRIMARY KEY ("role_route_id")
);
...
-- AddForeignKey
ALTER TABLE "Route" ADD CONSTRAINT "Route_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "Route"("route_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoleRoute" ADD CONSTRAINT "FK_role_route_role_id" FOREIGN KEY ("role_id") REFERENCES "Role"("role_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoleRoute" ADD CONSTRAINT "FK_role_route_route_id" FOREIGN KEY ("route_id") REFERENCES "Route"("route_id") ON DELETE RESTRICT ON UPDATE CASCADE;
